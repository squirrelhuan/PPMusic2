package com.example.ppmusic.ui;

import com.example.ppmusic.R;
import com.example.ppmusic.utils.StuDBHelper;
...
public class SQLiteActivity extends Activity {
	...
	class CreateListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			Toast.makeText(SQLiteActivity.this, "创建StuDBHelper对象", 3000).show();
		}
	}
	...
	class UpdateListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			StuDBHelper dbHelper = new StuDBHelper(SQLiteActivity.this,
					"stu_db", null, 2);
			SQLiteDatabase db = dbHelper.getReadableDatabase();
			Toast.makeText(SQLiteActivity.this, "数据库版本的更新,由原来的1变为2", 3000).show();
		}
	}
	...
	class InsertListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			// 关闭数据库
			db.close();
			Toast.makeText(SQLiteActivity.this, "插入数据的方法", 3000).show();
		}
	}
	...
	class QueryListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			// 关闭数据库
			db.close();
			Toast.makeText(SQLiteActivity.this, "查询数据的方法", 3000).show();
		}
	}
	...
	class ModifyListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			Toast.makeText(SQLiteActivity.this, " 修改数据的方法", 3000).show();
		}
	}
	...
	class DeleteListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			Toast.makeText(SQLiteActivity.this, " 删除数据的方法", 3000).show();
		}
	}
}