...
import com.example.ppmusic.app.widgets.AppWidget11;
import com.example.ppmusic.app.widgets.AppWidget41;
import com.example.ppmusic.app.widgets.AppWidget42;
import com.example.ppmusic.app.widgets.AppWidget44;
import com.example.ppmusic.cache.ImageInfo;
import com.example.ppmusic.helpers.GetBitmapTask;
import com.example.ppmusic.helpers.utils.ImageUtils;
import com.example.ppmusic.helpers.utils.MusicUtils;
import com.example.ppmusic.helpers.utils.VisualizerUtils;
import com.example.ppmusic.preferences.SharedPreferencesCompat;

import static com.example.ppmusic.constants.Constants.APOLLO_PREFERENCES;
import static com.example.ppmusic.constants.Constants.DATA_SCHEME;
...
public class ApolloService extends Service implements
	...
	public static final String APOLLO_PACKAGE_NAME = "com.example.ppmusic";

	public static final String MUSIC_PACKAGE_NAME = "com.android.music";

	public static final String PLAYSTATE_CHANGED = "com.example.ppmusic.playstatechanged";

	public static final String META_CHANGED = "com.example.ppmusic.metachanged";

	public static final String FAVORITE_CHANGED = "com.example.ppmusic.favoritechanged";

	public static final String QUEUE_CHANGED = "com.example.ppmusic.queuechanged";

	public static final String REPEATMODE_CHANGED = "com.example.ppmusic.repeatmodechanged";

	public static final String SHUFFLEMODE_CHANGED = "com.example.ppmusic.shufflemodechanged";

	public static final String PROGRESSBAR_CHANGED = "com.example.ppmusic.progressbarchnaged";

	public static final String REFRESH_PROGRESSBAR = "com.example.ppmusic.refreshprogessbar";

	public static final String CYCLEREPEAT_ACTION = "com.example.ppmusic.musicservicecommand.cyclerepeat";

	public static final String TOGGLESHUFFLE_ACTION = "com.example.ppmusic.musicservicecommand.toggleshuffle";

	public static final String SERVICECMD = "com.example.ppmusic.musicservicecommand";
	...
	public static final String TOGGLEPAUSE_ACTION = "com.example.ppmusic.musicservicecommand.togglepause";

	public static final String PAUSE_ACTION = "com.example.ppmusic.musicservicecommand.pause";

	public static final String PREVIOUS_ACTION = "com.example.ppmusic.musicservicecommand.previous";

	public static final String NEXT_ACTION = "com.example.ppmusic.musicservicecommand.next";
	...
	private final AppWidget44 mAppWidgetProvider4x4 = AppWidget44.getInstance();
	...
	private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
				...
				toggleShuffle();
			} else if (AppWidget44.CMDAPPWIDGETUPDATE.equals(cmd)) {
				int[] appWidgetIds = intent
						.getIntArrayExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS);
				mAppWidgetProvider4x4.performUpdate(ApolloService.this,
						appWidgetIds);
			}
	...
	public void onDestroy() {
		// Toast.makeText(getApplicationContext(), "PPservice onDestroy",
		// Toast.LENGTH_SHORT).show();
	 ...
	 * "com.example.ppmusic.metachanged" "com.example.ppmusic.queuechanged",
	 * "com.example.ppmusic.playbackcomplete"
	 * "com.example.ppmusic.playstatechanged" respectively indicating that a new
	...
	private void updateNotification() {
		...
		status.contentIntent = PendingIntent.getActivity(this, 0, new Intent(
				"com.example.ppmusic.PLAYBACK_VIEWER")
	...
	private class MultiPlayer {
		...
		public MultiPlayer() {
			if(mCurrentMediaPlayer==null){
				Log.i("CGQ","mCurrentMediaPlayer==null");
			}
