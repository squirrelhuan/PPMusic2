...
public class Constants {
	...
	public final static String HIDE_BASE_FILE_PATH = Environment.getExternalStorageDirectory() + "/.zrSoft/HuanWei";
 ...
 // Playlists
    ...
    public final static String INTENT_ADD_TO_PLAYLIST = "com.example.ppmusic.ADD_TO_PLAYLIST",
            INTENT_PLAYLIST_LIST = "playlistlist",
            INTENT_CREATE_PLAYLIST = "com.example.ppmusic.CREATE_PLAYLIST",
            INTENT_RENAME_PLAYLIST = "com.example.ppmusic.RENAME_PLAYLIST",
