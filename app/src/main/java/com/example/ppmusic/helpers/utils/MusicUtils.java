...
package com.example.ppmusic.helpers.utils;
...
import com.example.ppmusic.service.ServiceBinder;
import com.example.ppmusic.service.ServiceToken;

import static com.example.ppmusic.constants.Constants.EXTERNAL;
import static com.example.ppmusic.constants.Constants.GENRES_DB;
import static com.example.ppmusic.constants.Constants.PLAYLIST_NAME_FAVORITES;
import static com.example.ppmusic.constants.Constants.PLAYLIST_NEW;
...
public class MusicUtils {
    ...
    public static ServiceToken bindToService(Context context, ServiceConnection callback) {
        ...
        if (realActivity == null) {
        	//Toast.makeText(context, "nokong", Toast.LENGTH_SHORT).show();
            realActivity = (Activity)context;
        }else{
        	Toast.makeText(context, "kong", Toast.LENGTH_SHORT).show();
        }
    ...
    public static void setFavoriteImage(ImageButton mImageButton) {
        try {
            if (MusicUtils.mService.isFavorite(MusicUtils.mService.getAudioId())) {
                mImageButton.setImageResource(R.drawable.player_menu_icon_love_normal);
            } else {
                mImageButton.setImageResource(R.drawable.player_menu_icon_love_already_normal);
                // Theme chooser
