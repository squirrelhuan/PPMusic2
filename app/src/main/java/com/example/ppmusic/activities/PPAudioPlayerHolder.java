...
import com.example.ppmusic.ui.adapters.PagerAdapter;
...
/**
 * @author Andrew Neal
 * @Note This is the "holder" for the @MainFragment4(queue) and @AudioPlayerFragment
 */
public class PPAudioPlayerHolder extends Activity implements ServiceConnection {
    ...
    public void initPager() {
       /* // Initiate PagerAdapter
        ...
        mPagerAdapter.addFragment(new MainFragment4(bundle));
        // Artists
